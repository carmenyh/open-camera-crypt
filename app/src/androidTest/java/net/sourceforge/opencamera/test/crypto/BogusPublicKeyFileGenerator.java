package net.sourceforge.opencamera.test.crypto;
...
public class BogusPublicKeyFileGenerator {
    public static void generateBogusPublicKey(String filename) {
	...
	try {
	    ...
	    PemWriter pempublic = new PemWriter(new FileWriter(new File(filename)));
